...
class WalkForwardOpt:
    ...
    def rolling_split(self, data, n: int, window_len: int, set_lens: int, left_to_right=False):
        """
    ...
    def rolling_split_plot(self, data, n: int, window_len: int, set_lens: int, left_to_right=False, plot=True, trace_names=['in_sample', 'out_sample']):
        """
    ...
    def in_sample_prices(self, data, n: int, window_len: int, set_lens: int, left_to_right=False):
        """
