...
def vbt_saver_printer(
    ...
    stats_dir = f"{save_dir}/{strategy_logic}/stats/{strategy_config}"
    os.makedirs(stats_dir, exist_ok=True)
    position_dir = f"{save_dir}/{strategy_logic}/position/{strategy_config}"
    os.makedirs(position_dir, exist_ok=True)
    metric_df_dir = f"{save_dir}/{strategy_logic}/metric_df/{strategy_config}"
    os.makedirs(metric_df_dir, exist_ok=True)
    asset_dir = f"{save_dir}/{strategy_logic}/asset/{strategy_config}"
    os.makedirs(asset_dir, exist_ok=True)
    trade_pnl_dir = f"{save_dir}/{strategy_logic}/trade_pnl/{strategy_config}"
